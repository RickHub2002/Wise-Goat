    ...
    try {
        const response = await fetch('https://pt.libretranslate.com/translate', {
            ...
            body: JSON.stringify({
                ...
                source: 'auto',         // A API irá detectar o idioma automaticamente
                target: 'pt',           // Tradução para o português
                format: 'text',         // Tipo de conteúdo
                alternatives: 3,        // Número de traduções alternativas
                api_key: ''             // Se necessário, coloque sua chave API aqui
            }),
        });
        ...
        console.log('Texto traduzido:', data.translatedText);  // Log para ver se a tradução chegou corretamente
